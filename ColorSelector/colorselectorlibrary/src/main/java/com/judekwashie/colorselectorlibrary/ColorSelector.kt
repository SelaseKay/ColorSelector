package com.judekwashie.colorselectorlibrary
...
constructor(context: Context, attributeSet: AttributeSet? = null,
            defStyleAttr: Int = 0, defStyleRes: Int = 0) : LinearLayout(context, attributeSet, defStyleAttr, defStyleRes){
    ...
    init {
        ...
        colorEnabled.setOnCheckedChangeListener { button, b ->
            broadcastColor()
        }
    }
    ...
    private fun broadcastColor() {
        ...
        colorSelectListeners.forEach{function->
            function(color)
        }
    }
}